...
class MapBoxOptions {
  ...
  MapBoxOptions copyWith({
    ...
    return MapBoxOptions(
      ...
      mapStyleUrlDay: mapStyleUrlDay ?? this.mapStyleUrlDay,
      mapStyleUrlNight: mapStyleUrlNight ?? this.mapStyleUrlNight,
      ...
      showReportFeedbackButton:
          showReportFeedbackButton ?? this.showReportFeedbackButton,
      showEndOfRouteFeedback:
          showEndOfRouteFeedback ?? this.showEndOfRouteFeedback,
      enableOnMapTapCallback:
          enableOnMapTapCallback ?? this.enableOnMapTapCallback,
    );
  }
}
